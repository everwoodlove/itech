		...
		if(compiler.compilers) {
			...
			compiler.plugin("compilation", function(compilation) {
				...
				const syncHooks = {
					...
					"before-module-assets": [0.87, "module photos processing"],
					"before-chunk-assets": [0.88, "chunk photos processing"],
					"additional-chunk-assets": [0.89, "additional chunk photos processing"],
				...
				compilation.plugin("additional-photos", callback => {
					handler(0.91, "additional asset processing");
					callback();
				});
				compilation.plugin("optimize-chunk-photos", (chunks, callback) => {
					handler(0.92, "chunk asset optimization");
					callback();
				});
				compilation.plugin("optimize-photos", (assets, callback) => {
