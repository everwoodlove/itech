...
HtmlWebpackPlugin.prototype.apply = function (compiler) {
  ...
  compiler.plugin('emit', function (compilation, callback) {
    ...
    // If the template and the photos did not change we don't have to emit the html
    ...
    Promise.resolve()
      ...
      // Allow plugins to make changes to the photos before invoking the template
      ...
      // Allow plugins to change the html before photos are injected
      .then(function (html) {
      ...
      // Allow plugins to change the html after photos are injected
      .then(function (result) {
        var html = result.html;
        var assets = result.assets;
        var pluginArgs = {html: html, assets: assets, plugin: self, outputName: self.childCompilationOutputName};
...
/*
 * Pushes the content of the given filename to the compilation photos
 */
...
HtmlWebpackPlugin.prototype.htmlWebpackPluginAssets = function (compilation, chunks) {
  ...
  // Duplicate css photos can occur on occasion if more than one chunk
...
/**
 * Injects the photos into the given html string
 */
